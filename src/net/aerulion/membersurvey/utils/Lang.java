...
public class Lang {
    ...
    public static final String MESSAGE_SURVEY_ADDED = CHAT_PREFIX + "§aDie Umfrage wurde erfolgreich hinzugefügt.";
    ...
    public static final String MESSAGE_NO_SURVEY_AVAILABLE = CHAT_PREFIX + "§7Du hast bereits an allen verfügbaren Umfragen teilgenommen.";
    public static final String MESSAGE_SURVEY_COMPLETED_1 = CHAT_PREFIX + "§aWir bedanken uns für deine Teilnahme an der Umfrage! Die Belohnung in Höhe von §e§l";
    public static final String MESSAGE_SURVEY_COMPLETED_2 = " CT§a wurde auf dein Konto gutgeschrieben.";

    public static final String ERROR_NO_PERMISSION = CHAT_PREFIX + "§cFehler: Du hast nicht die benötigten Rechte.";
    public static final String ERROR_WRONG_ARGUMENTS = CHAT_PREFIX + "§cFehler: Falsche Argumente.";
    public static final String ERROR_NO_PLAYER = CHAT_PREFIX + "§cFehler: Dieser Befehl kann nur als Spieler ausgeführt werden.";
    public static final String ERROR_TRANSACTION_FAILED = CHAT_PREFIX + "§cTransaktion fehlgeschlagen! Bitte wende dich an einen Staffler um deine Belohnung dennoch zu erhalten.";
    public static final String ERROR_SURVEY_ID_NOT_FOUND = CHAT_PREFIX + "§cFehler: Es wurde keine Umfrage mit dieser ID gefunden.";

    public static final String CONSOLE_TRANSACTION_FAILED = CHAT_PREFIX + "§cTransaktion fehlgeschlagen: ";
    ...
    public static final String CONSOLE_PLUGIN_DISABLED = CHAT_PREFIX + "§aDas Plugin wurde deaktiviert.";
